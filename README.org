...
**** Git
En primer lugar será necesario [[https://git-scm.com/book/en/v2/Getting-Started-Installing-Git][git]], que como usuarios de GitHub
debería estar instalado. En caso contrario, siga las instrucciones del
enlace anterior.

Una vez instalado git, vaya a la terminal de comandos y escriba:
